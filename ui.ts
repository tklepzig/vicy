...
// @tklepzig/offline-kit; here we only render the emitted state into the
// always-visible footer badge. Strings stay English (infrastructure status).
...
observeOfflineReadiness({ onStatus: renderOfflineStatus });
